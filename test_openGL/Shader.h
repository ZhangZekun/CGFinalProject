...
public:
	...
	Shader(const char* vertexPath, const char* fragmentPath)
	{
		...
		try
		{
			...
			// 文件流转移到字符串流中，因为创建shader时要传入char*字符创
	...
	void checkCompileErrors(unsigned int shader, std::string type)
	{
		...
		if (type != "Shader Program")
		{
			...
			if (!success)
			{
				...
				std::cout << "ERROR::Compiler error of type: " << type << "\n" << infoLog << "\n -- --------------------------------------------------- -- " << std::endl;
			}
		}
		else
		{
			...
			if (!success)
			{
				...
				std::cout << "ERROR::Link error of type: " << type << "\n" << infoLog << "\n -- --------------------------------------------------- -- " << std::endl;
			}
		}
	}
};
